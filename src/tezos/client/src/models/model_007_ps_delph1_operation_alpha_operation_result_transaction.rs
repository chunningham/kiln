...
pub struct Model007PsDelph1OperationAlphaOperationResultTransaction {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "storage", skip_serializing_if = "Option::is_none")]
    pub storage: Option<crate::models::Micheline007PsDelph1MichelsonV1Expression>,
    ...
    #[serde(rename = "allocated_destination_contract", skip_serializing_if = "Option::is_none")]
    pub allocated_destination_contract: Option<bool>,
    #[serde(rename = "errors")]
    pub errors: Vec<serde_json::Value>,
}

impl Model007PsDelph1OperationAlphaOperationResultTransaction {
    pub fn new(status: Status, errors: Vec<serde_json::Value>) -> Model007PsDelph1OperationAlphaOperationResultTransaction {
