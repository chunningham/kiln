...
pub struct Model007PsDelph1OperationAlphaContents {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "level")]
    pub level: i32,
