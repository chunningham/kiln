...
impl InlineObject8 {
    pub fn new(script: crate::models::Micheline007PsDelph1MichelsonV1Expression, storage: crate::models::Micheline007PsDelph1MichelsonV1Expression, input: crate::models::Micheline007PsDelph1MichelsonV1Expression, amount: String, chain_id: crate::models::ChainId) -> InlineObject8 {
        InlineObject8 {
            script,
            storage,
            input,
