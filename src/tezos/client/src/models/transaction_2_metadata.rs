...
pub struct Transaction2Metadata {
    ...
    pub operation_result: crate::models::Model007PsDelph1OperationAlphaOperationResultTransaction,
...
impl Transaction2Metadata {
    pub fn new(balance_updates: Vec<crate::models::OneOfobjectobjectobjectobject>, operation_result: crate::models::Model007PsDelph1OperationAlphaOperationResultTransaction) -> Transaction2Metadata {
        Transaction2Metadata {
            balance_updates,
            operation_result,
