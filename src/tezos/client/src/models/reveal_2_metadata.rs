...
pub struct Reveal2Metadata {
    ...
    pub operation_result: crate::models::Model007PsDelph1OperationAlphaOperationResultReveal,
...
impl Reveal2Metadata {
    pub fn new(balance_updates: Vec<crate::models::OneOfobjectobjectobjectobject>, operation_result: crate::models::Model007PsDelph1OperationAlphaOperationResultReveal) -> Reveal2Metadata {
        Reveal2Metadata {
            balance_updates,
            operation_result,
