...
pub struct Delegation2Metadata {
    ...
    pub operation_result: crate::models::Model007PsDelph1OperationAlphaOperationResultDelegation,
...
impl Delegation2Metadata {
    pub fn new(balance_updates: Vec<crate::models::OneOfobjectobjectobjectobject>, operation_result: crate::models::Model007PsDelph1OperationAlphaOperationResultDelegation) -> Delegation2Metadata {
        Delegation2Metadata {
            balance_updates,
            operation_result,
